		...
		while (entries.hasNext()) {
			...
			if (optionID.equals(OPTION_PerformVisibilityCheck)) {
				...
				if (optionValue.length() == 0) {
					...
					this.fieldPrefixes = CharOperation
							.splitAndTrimOn(',', optionValue.toCharArray());
				}
				continue;
				...
				if (optionValue.length() == 0) {
					...
					this.staticFieldPrefixes = CharOperation
							.splitAndTrimOn(',', optionValue.toCharArray());
				}
				continue;
				...
				if (optionValue.length() == 0) {
					...
					this.localPrefixes = CharOperation
							.splitAndTrimOn(',', optionValue.toCharArray());
				}
				continue;
				...
				if (optionValue.length() == 0) {
					...
					this.argumentPrefixes = CharOperation
							.splitAndTrimOn(',', optionValue.toCharArray());
				}
				continue;
				...
				if (optionValue.length() == 0) {
					...
					this.fieldSuffixes = CharOperation
							.splitAndTrimOn(',', optionValue.toCharArray());
				}
				continue;
				...
				if (optionValue.length() == 0) {
					...
					this.staticFieldSuffixes = CharOperation
							.splitAndTrimOn(',', optionValue.toCharArray());
				}
				continue;
				...
				if (optionValue.length() == 0) {
					...
					this.localSuffixes = CharOperation
							.splitAndTrimOn(',', optionValue.toCharArray());
				}
				continue;
				...
				if (optionValue.length() == 0) {
					...
					this.argumentSuffixes = CharOperation
							.splitAndTrimOn(',', optionValue.toCharArray());
				}
				continue;
			}
